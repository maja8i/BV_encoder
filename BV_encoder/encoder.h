...
struct corners
{
	//Matrix of (b + 1) matrices (of doubles), to store the corner coordinates of each occupied octree block at each octree level
	Eigen::Matrix<Eigen::MatrixXd, (b + 1), 1> corner_coords;

	//Matrix of (b + 1) matrices (of doubles), to store only the unique corner coordinates at each octree level
